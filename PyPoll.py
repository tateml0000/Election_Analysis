...
# Cnadidate Options and candidate votes
candidate_options = []
candidate_votes = {}
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        if candidate_name not in candidate_options:
            ...
            #Begin tracking that canddiate's vote count
...
with open(file_to_save, "w") as txt_file:
    ...
    # Determine the percentage of votes for each candidate by through through the counts
